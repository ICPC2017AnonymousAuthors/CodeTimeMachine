...
[![Code Time Machine In Action](http://img.youtube.com/vi/czdsXL93iWU/maxresdefault.jpg)](https://youtu.be/czdsXL93iWU "Code Time Machine In Action")

## Installation
### Binary
To install using pre-built  binary, first download [the latest release](https://github.com/ICPC2017AnonymousAuthors/CodeTimeMachine/releases/latest). Then, go to IntelliJ IDE > Preference > Plugin > install plugin from Hard.
...
## Issues
For known issues, please check [the issues](https://github.com/ICPC2017AnonymousAuthors/CodeTimeMachine/issues).
